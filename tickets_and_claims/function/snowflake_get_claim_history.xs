function "snowflake_get_claim_history" {
  description = "Snowflake lookup for prior claims and fraud indicators used by the auto-approval rule."
  input {
    int customer_id
  }
  stack {
  ...
  response = $history
  guid = "kUsmUqky5cf4S4QaDZfHBqkN6mk"
}
